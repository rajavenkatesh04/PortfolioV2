...
export default function Work() {
    return (
        <div id={"work"} className={"w-full px-[12%] py-10 scroll-mt-20"}>
            ...
            <p className={"text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo"}>I'm a Java developer from India, experienced in WebDev & Java I aim to create stunning minimalistic websites.</p>

            <div className={"grid grid-cols-auto my-10 gap-5 font-Ovo"}>
